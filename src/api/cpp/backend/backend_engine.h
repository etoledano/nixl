...
public:
    nixlBackendEngine(const nixlBackendInitParams* init_params) : localAgent(init_params->localAgent)
    {
    ...
    virtual nixl_status_t getPublicData(const nixlBackendMD* meta, std::string& str) const { return NIXL_ERR_BACKEND; };
    ...
    virtual nixl_status_t loadRemoteConnInfo(const std::string& remote_agent, const std::string& remote_conn_info)
    {
        return NIXL_ERR_BACKEND;
    }

    // Load remtoe metadata, if supported.
    virtual nixl_status_t loadRemoteMD(
    ...
    virtual nixl_status_t loadLocalMD(nixlBackendMD* input, nixlBackendMD*& output) { return NIXL_ERR_BACKEND; }
    ...
    virtual nixl_status_t genNotif(const std::string& remote_agent, const std::string& msg) { return NIXL_ERR_BACKEND; }
