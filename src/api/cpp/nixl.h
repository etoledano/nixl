...
public:
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t getPluginParams(const nixl_backend_t& type, nixl_mem_list_t& mems, nixl_b_params_t& params) const;
    /**
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t getBackendParams(const nixlBackendH* backend, nixl_mem_list_t& mems, nixl_b_params_t& params) const;
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t createBackend(const nixl_backend_t& type, const nixl_b_params_t& params, nixlBackendH*& backend);
    /**
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t registerMem(const nixl_reg_dlist_t& descs, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t deregisterMem(const nixl_reg_dlist_t& descs, const nixl_opt_args_t* extra_params = nullptr);
     ...
     * @return nixl_status_t  Error code if call was not successful
     */
    nixl_status_t createXferReq(
            const nixl_xfer_op_t& operation, const nixl_xfer_dlist_t& local_descs,
            const nixl_xfer_dlist_t& remote_descs, const std::string& remote_agent, nixlXferReqH*& req_hndl,
            const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     */
    nixl_status_t postXferReq(nixlXferReqH* req_hndl, const nixl_opt_args_t* extra_params = nullptr) const;
     ...
     * @return nixl_status_t Error code if call was not successful
     */
    nixl_status_t getNotifs(nixl_notifs_t& notif_map, const nixl_opt_args_t* extra_params = nullptr);
    ...
    nixl_status_t genNotif(
            const std::string& remote_agent, const nixl_blob_t& msg, const nixl_opt_args_t* extra_params = nullptr);
