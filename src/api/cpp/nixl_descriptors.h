...
public:
     ...
     */
    nixlBasicDesc(const uintptr_t& addr, const size_t& len, const uint32_t& dev_id);
    /**
...
public:
     ...
     */
    nixlBlobDesc(const uintptr_t& addr, const size_t& len, const uint32_t& dev_id, const nixl_blob_t& meta_info);
    /**
