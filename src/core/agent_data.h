...
private:
    ...
    std::unordered_map<std::string, std::set<nixl_backend_t>, std::hash<std::string>, strEqual> remoteBackends;
    std::unordered_map<std::string, nixlRemoteSection*, std::hash<std::string>, strEqual> remoteSections;
