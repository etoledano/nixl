...
void
sendToInitiator(const char* ip, int port, std::string data)
{
...
main(int argc, char* argv[])
{
    ...
    if (role == "target") {
        ...
        ret = agent.createXferReq(NIXL_WRITE, dram_initiator_ucx, dram_target_ucx, "target", treq, &extra_params);
        if (ret != NIXL_SUCCESS) {
